      ...
      <div className="flex-1 relative overflow-hidden">
        ...
        {cameraState === 'ready' && (
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="border-2 border-dashed border-white/40 rounded-lg w-3/4 h-4/5 flex items-end justify-center pb-8">
          ...
          <div className="absolute top-safe-top left-0 right-0 px-5 pt-4">
            <div className="flex items-center justify-between">
              ...
              <div className="bg-black/40 rounded-full px-3 py-1.5">
                <span className={cn(
                  'text-xs',
                  poseStatus === 'ready' ? 'text-status-success' : 'text-status-warning'
                )}>
            ...
            <div className="mt-2 h-1 bg-white/20 rounded-full overflow-hidden">
              <div
                className="h-full bg-status-error rounded-full transition-all duration-1000"
        ...
        {cameraState === 'error' && (
          <div className="absolute inset-0 flex items-center justify-center bg-black/70">
            <div className="text-center px-6">
              <p className="text-white text-base mb-4">{cameraError || poseError}</p>
              <button
                type="button"
                onClick={onCancel}
        ...
        <div className="flex items-center justify-around">
          ...
          {cameraState === 'ready' && (
            <button
              ...
              aria-label="촬영 시작"
            >
              <div className="w-12 h-12 rounded-full bg-status-error" />
            </button>
          )}
          ...
          {cameraState === 'recording' && (
            <button
              ...
              aria-label="촬영 중지"
            >
              <div className="w-8 h-8 rounded-sm bg-status-error" />
            </button>
          )}
